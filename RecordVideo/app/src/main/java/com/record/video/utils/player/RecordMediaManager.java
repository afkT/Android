 ...
 * Created by Ttt
 */
public class RecordMediaManager implements MediaPlayer.OnBufferingUpdateListener,
	 ...
	 */
	public boolean prePlayer(Context mContext, String playUri, boolean isLooping){
	...
	public void onBufferingUpdate(MediaPlayer mp, int percent) {
		DevLogger.dTag(TAG, "onBufferingUpdate - percent: " + percent);
		// ---
		if(mMeidaListener != null){
